...
<nav id="main-navigation" class="menu main-navigation top-navigation navigation-collapsible menu-button" role="navigation" aria-label="<?php esc_attr_e( 'Top Menu', 'wireframe' ); ?>">
