...
>>>>>>> 9aa46235a6bd4f104c917e391e1782689ed25e0e
				...
				<?php if(has_nav_menu('main')): ?>
					...
					<button id= "menu-toggle-close" class="menu-toggle-close" aria-controls="main-menu" aria-expanded="false">
						<img class="main-close-icon" src="<?php echo get_template_directory_uri(); ?>/assets/images/close-icon.png" style="height:25px;" />
					</button>
		...
		<div id="global-header" style="background-color:<?php echo confget('background-color'); ?>;" class="flex-container global-header" >
			...
			<div class="gh-item gh-item-1">
			<button id= "menu-toggle-open" class="menu-toggle-open" aria-controls="main-menu" aria-expanded="false">
